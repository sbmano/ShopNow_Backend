...
public class WebSecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors->cors.disable()).csrf(csrf->csrf.disable()).authorizeHttpRequests((auth)->auth.requestMatchers("api/addrole","api/auth/login","/api/auth/signup",
                                "api/auth/confirm-account","/api/saveProduct","/api/**").permitAll()
